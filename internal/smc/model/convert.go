...
var (
	ErrInsufficientBytes = errors.New("not enough bytes to convert value")
	ErrUnsupportedSize   = errors.New("unsupported byte length for value conversion")
)
...
func (v SMCVal) Int(order binary.ByteOrder) (int64, error) {
	...
	case 2:
		return int64(int16(order.Uint16(v.Bytes))), nil
	case 4:
		return int64(int32(order.Uint32(v.Bytes))), nil
	case 8:
		return int64(order.Uint64(v.Bytes)), nil
	default:
		return 0, ErrUnsupportedSize
	}
}
